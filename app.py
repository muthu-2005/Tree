...
def signup():
    if request.method == 'POST':
        ...
        try:
            ...
            parsed_phone = phonenumbers.parse(phone, "IN")  # Default country set to India
            if not phonenumbers.is_valid_number(parsed_phone):
                return redirect(url_for('signup', message="Invalid phone number format!", type="error"))
            ...
            ref.set({
                'name': name,
                'email': email,
                'phone': formatted_phone,  # Store formatted phone number
...
def drop():
    ...
    return render_template("dope-drop.html")
...
def rebuild():
    ...
    return render_template("AfterDoping.html")
...
@app.route('/drugs')
def drug():
    return render_template("EffectsOfDoping.html")


@app.route('/prohbit')
def drugs():
    return render_template("ProhibitedDrugs.html")
